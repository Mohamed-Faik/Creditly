        ...
        return (
            ...
            >
                ...
                <div className={cn(
                    ...
                    {/* --- CARD BACK --- */}
                    <div className={cn("absolute h-full w-full rounded-xl [backface-visibility:hidden] [transform:rotateY(180deg)]", colorClass ? `bg-gradient-to-br ${colorClass} text-white` : "bg-card text-card-foreground")}>
